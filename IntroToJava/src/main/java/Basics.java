...
public class Basics {
    ...
    public static void main(final String[] args) {
        ...
        String to_split = "Idol Long Oolong Vertical Europe University Toyota";
        System.out.println(split(to_split));
    }
    ...
    public static String split(String to_split) {
        ...
        String[] stringSplit = to_split.split(" ");
        for (int i = 0; i < 7; i++) {
            ret.append(stringSplit[i].charAt(0));
        }
